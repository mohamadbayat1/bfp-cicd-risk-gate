...
_Generated 2026-07-10T17:13:42.056161+00:00 — real scored campaign build; true positive (the build genuinely failed). Generated with the production prompt (see LLM_PROMPT.md)._
